...
<head>
    ...
    .stepper {
    display: flex;
    justify-content: space-around; /* Change from space-between to space-around for reduced spacing */
    padding: 10px;
...
.step {
    ...
    position: relative;
    text-align: center;
    padding: 0 5px; /* Add small padding to reduce space */
}
...
.step::before {
    ...
    position: absolute;
    top: 1.75rem; 
    left: 50%; /* Reduce the left distance */
    width: 50%; /* Reduce the line width */
    height: 2px;
    background-color: #e0e0e0;
    z-index: -1;
}
        ...
        <aside id="sidebar" class="sidebar">
            ...
            <nav class="flex flex-col space-y-2">
                ...
                <button class="block py-2.5 px-4 rounded bg-blue-500 text-white hover:bg-blue-600 transition duration-200">
                    <i class="fas fa-level-up-alt"></i> See Applicantions
                </button>
